...
@Mod("a2kn1gh7")
public class A2kn1gh7 {
    public static final String MODID = "a2kn1gh7";
    public static final String NAME = "A2kn1gh7";
    public static final String MC_VERSION = "1.16.5";
    public static final String MOD_VERSION = "1.1.0";
    public static final String VERSION = MC_VERSION + "-" + MOD_VERSION;

    public static final Logger LOGGER = LogManager.getLogger();
    public static A2kn1gh7 INSTANCE = null;
    ...
    private void enqueueIMC(final InterModEnqueueEvent event) {
        ...
        InterModComms.sendTo("a2kn1gh7", "helloworld", () -> {
